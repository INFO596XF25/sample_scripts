...
::: {.callout-note}
## Research Question
What environmental factors drive the distribution of `r params$species` across the United States?
:::

Species distribution models intend to summarize how environmental conditions shape where species occur [@elith2009species]. This report briefly examines `r params$species` distribution using occurrence data from GBIF and particular environmental predictors.
...
n_records_target <- params$n_records
```
